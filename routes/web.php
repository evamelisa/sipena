...
use App\Http\Controllers\JadwalSamsatController;
...
// Route group untuk admin, pakai middleware AdminAuth
Route::prefix('admin')->middleware('admin.auth')->group(function () {

Route::get('/dashboard', [AdminController::class, 'dashboard'])
    ->name('admin.dashboard');

Route::get('/laporan/{laporan}', [AdminController::class, 'show'])
    ->name('admin.show');

Route::delete('/laporan/{laporan}', [AdminController::class, 'destroy'])
    ->name('admin.destroy');
